<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:38:"./template/pc/rainbow/index/index.html";i:1524882686;s:57:"/home/wwwroot/shop/template/pc/rainbow/public/header.html";i:1524803840;s:57:"/home/wwwroot/shop/template/pc/rainbow/public/footer.html";i:1522317287;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
					...
					<div class="item">
						...
						<div class="cata-nav-layer">
							...
							<div class="advertisement_down">
								<?php $pid =10+$kr;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1526277600 and end_time > 1526277600 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("5")->select();
...
foreach($result as $key=>$v3):       
    ...
    ?>
							...
							<?php $pid =51;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1526277600 and end_time > 1526277600 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(is_array($ad_position) && !in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
<div id="myCarousel" class="carousel clearfix">
	<ul class="carousel-inner">
        <?php $pid =2;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1526277600 and end_time > 1526277600 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("5")->select();
if(is_array($ad_position) && !in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$v1):       
    ...
    ?>
		<li class="item" style="background:<?php echo $v1['bgcolor']; ?>;"><!-- href="<?php echo $v1[ad_link]; ?>" -->
			<a class="item-pic"   <?php if($v1['target'] == 1): ?>target="_blank"<?php endif; ?>>
	...
	<?php $pid =52;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1526277600 and end_time > 1526277600 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("2")->select();
if(is_array($ad_position) && !in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$vb):       
    ...
    ?><!-- href="<?php echo $vb[ad_link]; ?>" -->
		<a class="banner-right-item t-all" ><img src="<?php echo $vb[ad_code]; ?>" alt="<?php echo $vb[title]; ?>" /></a>
	<?php endforeach; ?>
	</div>
</div>

<div class="adv3 w1224 clearfix">
	<?php $pid =50;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1526277600 and end_time > 1526277600 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("3")->select();
if(is_array($ad_position) && !in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$vr):       
    ...
    ?><!-- href="<?php echo $vr[ad_link]; ?>" -->
	<a class="recommend-brand t-all" >
		<img class="w-100" src="<?php echo $vr[ad_code]; ?>" alt="<?php echo $vr[title]; ?>" title="<?php echo $vr[title]; ?>"/>
	</a>
	<?php endforeach; ?>
</div>

<?php $pid =49;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1526277600 and end_time > 1526277600 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(is_array($ad_position) && !in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
<div class="floor floor<?php echo $k+1; ?> w1224">
	...
	<div class="floor-main">
		<div class="floor-brand">
			<?php $pid =10+$k;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1526277600 and end_time > 1526277600 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(is_array($ad_position) && !in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$vl):       
    ...
    ?><!-- href="<?php echo $vl[ad_link]; ?>" -->
			<a class="brand-big" ><img class="w-100" src="<?php echo $vl[ad_code]; ?>" alt="<?php echo $vl[title]; ?>" /></a>
			<?php endforeach; $pid =20+$k;$ad_position = M("ad_position")->cache(true,TPSHOP_CACHE_TIME)->column("position_id,position_name,ad_width,ad_height","position_id");$result = M("ad")->where("pid=$pid  and enabled = 1 and start_time < 1526277600 and end_time > 1526277600 ")->order("orderby desc")->cache(true,TPSHOP_CACHE_TIME)->limit("1")->select();
if(is_array($ad_position) && !in_array($pid,array_keys($ad_position)) && $pid)
{
  M("ad_position")->insert(array(
         "position_id"=>$pid,
...
foreach($result as $key=>$vs):       
    ...
    ?><!-- href="<?php echo $vs[ad_link]; ?>" -->
			<a class="brand-samll" ><img class="w-100" src="<?php echo $vs[ad_code]; ?>" alt="<?php echo $vs[title]; ?>" /></a>
			<?php endforeach; ?>
		</div>
